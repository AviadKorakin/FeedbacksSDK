...
⚙️ **Prerequisite**: Ensure you have the **Form Generator API** set up and a valid form ID.

### 2️⃣ Displaying a Form

#### 🖼️ Instantiate and Display the Form Dialog:
```java
...
- 🖼️ **Margins**: Customize spacing between components.
...
🛠️ **Modular Components** supported by the library:
...
- 🖼️ **Glide**: For loading GIFs and images.
...
🎬 **See the Feedbacks Library in Action**:

<p align="center">
  <a href="https://www.youtube.com/watch?v=fRDOjQRgd2Q" target="_blank">
    <img src="https://img.youtube.com/vi/fRDOjQRgd2Q/0.jpg" alt="Feedbacks Library Demo" style="width:60%; height:auto;">
  </a>
</p>
